...
namespace skeleton.Controllers
{
    ...
    public class WineRatingsController : Controller
    {
        ...
        {
            // Calculate the values for placement and total score
            /*
             * 
             */
        ...
        // GET api/todos
        [HttpGet]
        [Route("GetScoreForWines", Name = "GetScoreForWines")]
        public IEnumerable<WineRatingScore> GetScoreForWines()
        {
            return Repo.GetScoreForWines();
        }
